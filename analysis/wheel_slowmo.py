...
# Shared with run_drive's `wheel` camera, so teleop and these clips draw the
# SAME stripes -- the whole point of the teleop view is comparability.
from aow_sim.wheel_overlay import (N_AXLES, add_stripes,  # noqa: F401
                                   stripe_frames)
